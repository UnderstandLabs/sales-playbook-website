...
export default function DiscoveryScripts() {
  ...
  const scripts: DiscoveryScript[] = [
    {
      id: "discovery-script",
      title: "Discovery Script",
      description: "List of 20+ questions to uncover the \"Dashboard Trap\" and qualify the opportunity.",
      pillar: ["all"],
      fileType: "PDF",
      downloadUrl: "/assets/discovery_script.pdf",
    },
  ];

  const filteredScripts = selectedPillar === "all" 
    ? scripts 
    : scripts.filter(script => script.pillar.includes(selectedPillar) || script.pillar.includes("all"));
        ...
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-xl text-gray-300">
              Structured questions to uncover needs and pain points
            </p>
          </div>
            ...
            {filteredScripts.length > 0 ? (
              filteredScripts.map((script) => (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <span className="text-xs font-mono text-muted-foreground border border-white/10 px-2 py-1 rounded">{script.fileType}</span>
                  </div>
              ...
              <div className="col-span-full text-center py-20">
                ...
                <p className="text-xl text-gray-400">
                  No discovery scripts found for {selectedPillar === "all" ? "this filter" : "this pillar"}
                </p>
          ...
          {filteredScripts.length > 0 && (
            <div className="mt-16 text-center">
              <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white/5 border border-white/10">
                <span className="text-gray-400">More discovery scripts coming soon...</span>
              </div>
            </div>
          )}
        </div>
